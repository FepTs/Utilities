"""
PyQt界面 v1.1 by FepTs

更新日志:
v1.1:标注清洗功能更新，现在可以保证剩余标签类的连续性了
...
class MainWindow(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("YoloUtilities-v1.1")
        self.resize(800, 600)
        self.init_ui()
